  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        ...
        setTriggers(triggersRes.data.slice(0, 8)); // Top 8 triggers
        ...
        {summary && (
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <Card>
              ...
              <CardContent>
                <p className="text-2xl font-bold">{summary.total_migraines}</p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-2xl font-bold">{summary.avg_severity.toFixed(1)}</p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-2xl font-bold">{summary.avg_sleep.toFixed(1)}h</p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-2xl font-bold">{summary.avg_stress.toFixed(1)}/5</p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-2xl font-bold">{Math.round(summary.avg_hydration)}ml</p>
